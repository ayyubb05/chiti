    ...
    <div className="w-full">
      <div className="w-full bg-green-800 rounded-t p-3">
        <div className="flex w-full">
          ...
          <div className="w-1/2 bg-green-900 rounded p-1 flex flex-col justify-center items-center text-center">
            <h2 className="text-sm font-semibold text-white">{group.name}</h2>
            <p className="text-xs text-white">Members: [ 1 / {group.group_size} ]</p>
